...
enum ModelType {
    ...
    MEDIUM("gemma4:e4b", 1.0, false, true, true),  // Good usable compromise and keeps things tight in flight.
    SMALL("gemma4:e2b", 1.0, false, true, true),   // Almost too small, but could work in small deployment constraints.
