...
enum ModelType {
    BIG("gemma4:26b", 0.8, false, true, true),     // Brilliant narrator. No notes.
    MEDIUM("gemma4:e4b", 0.6, false, true, true),  // Good usable compromise and keeps things tight in flight.
    SMALL("gemma4:e2b", 0.6, false, true, true),   // Almost too small, but could work in small deployment constraints.
